...
| --------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Structure       | `AppFrame`, `ShellLayout`, `Fixture`, `Plaque`, `Rail`, `Hero`, `PageHeader`, and `PageSection` support their documented slots. `Fixture` renders a section and owns only its structural frame and inset surface; consumers own the content hierarchy. An unlabeled `Rail` is hidden from assistive technology. `ShellLayout` is intentionally Effigy-flavored; the case-sensitive values empty, `prod`, and `production` are hidden. `Hero` and `PageHeader` render `h1`. |
