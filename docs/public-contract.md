...
| --------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Structure       | `AppFrame`, `ShellLayout`, `Fixture`, `Plaque`, `Medallion`, `Rail`, `Hero`, `PageHeader`, and `PageSection` support their documented slots. `Fixture` renders a section and owns only its structural frame and inset surface; consumers own the content hierarchy. `Medallion` renders a struck-metal inline marker with gold, silver, and bronze finishes; consumers own its short content and accessible label. An unlabeled `Rail` is hidden from assistive technology. `ShellLayout` is intentionally Effigy-flavored; the case-sensitive environment values empty, `prod`, and `production` are hidden. `headerInnerClassName` provides a consumer-owned alignment hook without styling Morass internals. `mobileNav` is a separate responsive navigation slot with an accessible label and optional consumer class; `navClassName` and `mobileNavClassName` style their respective landmarks. `Hero` and `PageHeader` render `h1`. |
